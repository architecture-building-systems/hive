...
BADGER_CONFIG = {'description': 'A simplistic implementation of SIA 380.1', 'name': 'sia380', 'id': '4b5ec46e-cafa-4a72-ac7b-fb839ce3c618', 'components': [{'subcategory': 'demand', 'inputs': [{'nick-name': 'A_w', 'type': 'float', 'name': 'A_w', 'description': 'A_w'}, {'nick-name': 'tau', 'type': 'float', 'name': 'tau', 'description': 'tau'}, {'nick-name': 'theta_e', 'type': 'float', 'name': 'theta_e', 'description': 'theta_e'}, {'nick-name': 'A_op', 'type': 'float', 'name': 'A_op', 'description': 'A_op'}, {'nick-name': 'g', 'type': 'float', 'name': 'g', 'description': 'g'}, {'nick-name': 'Vdot_e', 'type': 'float', 'name': 'Vdot_e', 'description': 'Vdot_e'}, {'nick-name': 't_B', 'type': 'float', 'name': 't_B', 'description': 't_B'}, {'nick-name': 'eta_rec', 'type': 'float', 'name': 'eta_rec', 'description': 'eta_rec'}, {'nick-name': 't_G', 'type': 'float', 'name': 't_G', 'description': 't_G'}, {'nick-name': 'theta_i', 'type': 'float', 'name': 'theta_i', 'description': 'theta_i'}, {'nick-name': 'phi_G', 'type': 'float', 'name': 'phi_G', 'description': 'phi_G'}, {'nick-name': 'I', 'type': 'float', 'name': 'I', 'description': 'I'}, {'nick-name': 'Vdot_inf', 'type': 'float', 'name': 'Vdot_inf', 'description': 'Vdot_inf'}, {'nick-name': 'U_w', 'type': 'float', 'name': 'U_w', 'description': 'U_w'}, {'nick-name': 't', 'type': 'float', 'name': 't', 'description': 't'}, {'nick-name': 'phi_B', 'type': 'float', 'name': 'phi_B', 'description': 'phi_B'}, {'nick-name': 'U_op', 'type': 'float', 'name': 'U_op', 'description': 'U_op'}, {'nick-name': 'phi_P', 'type': 'float', 'name': 'phi_P', 'description': 'phi_P'}, {'nick-name': 't_P', 'type': 'float', 'name': 't_P', 'description': 't_P'}, {'nick-name': 'f_sh', 'type': 'float', 'name': 'f_sh', 'description': 'f_sh'}], 'description': 'SIA 380.1 calculation for a single month', 'outputs': [{'nick-name': 'Q_H', 'type': 'float', 'name': 'Q_H', 'description': 'Q_H'}, {'nick-name': 'Q_T', 'type': 'float', 'name': 'Q_T', 'description': 'Q_T'}, {'nick-name': 'Q_V', 'type': 'float', 'name': 'Q_V', 'description': 'Q_V'}, {'nick-name': 'eta_g', 'type': 'float', 'name': 'eta_g', 'description': 'eta_g'}, {'nick-name': 'Q_i', 'type': 'float', 'name': 'Q_i', 'description': 'Q_i'}, {'nick-name': 'Q_s', 'type': 'float', 'name': 'Q_s', 'description': 'Q_s'}], 'name': 'SIA 380.1', 'id': '6bbb1401-7fb5-4219-ab56-e806b4ec3113', 'main-module': 'sia380', 'category': '[hive]', 'class-name': 'Sia380', 'abbreviation': 'sia380', 'main-function': 'monthly'}], 'version': '0.1', 'author': 'daren-thomas', 'include-files': ['sia380.py']}
