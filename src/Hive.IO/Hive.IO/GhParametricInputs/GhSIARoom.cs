...
namespace Hive.IO.GhParametricInputs
{
    public class GhSIARoom : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.GetData(5, ref siaRoom.UValueOpaque);
            DA.GetData(6, ref siaRoom.UValueTransparent);
            DA.GetData(7, ref siaRoom.GValue);
            DA.GetData(8, ref siaRoom.GValueTotal);
            DA.GetData(9, ref siaRoom.ShadingSetpoint);
