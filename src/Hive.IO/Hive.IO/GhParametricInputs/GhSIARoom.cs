...
namespace Hive.IO.GhParametricInputs
{
    public class GhSIARoom : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("coolingSetback", "coolingSetback", "Cooling setback 'Raumlufttemperatur Auslegung Kuehlung (Sommer) - Absenktemperatur'. in deg Celsius", GH_ParamAccess.item);
            pManager.AddNumberParameter("heatingSetback", "heatingSetback", "Heating setback 'Raumlufttemperatur Auslegung Heizen (Winter) - Absenktemperatur'. in deg Celsius", GH_ParamAccess.item);
            ...
            pManager.AddNumberParameter("ShadingSetpoint", "ShadingSetpoint", "g-ShadingSetpoint of windows 'Strahlungsleistung fuer Betaetigung Sonnenschutz' W/m^2", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.GetData(5, ref siaRoom.CoolingSetback);
            DA.GetData(6, ref siaRoom.HeatingSetback);
        ...
        /// </summary>
        protected override System.Drawing.Bitmap Icon => Properties.Resources.IO_Para_InputSIAroom;

        /// <summary>
        /// Gets the unique ID for this component. Do not change this ID after release.
        /// </summary>
        public override Guid ComponentGuid => new Guid("5a628fc1-283e-4549-a94c-09fa7f232e97");
    }
}