...
namespace ProvingGround.Conduit.Components
{
    public class nodeDrawChart : GH_Component
    {
        ...
        private Bitmap _fontCheckBM = new Bitmap(2000, 1000);
        private Graphics _fontSizer;
        ...
        public nodeDrawChart()
            : base("Hive Conduit Chart", "HiveConduitChart", "Extends the Conduit Chart Component", "[hive]", "Misc")
        {
        ...
        public override Guid ComponentGuid
        {
            get
            {
                return new Guid("aae8eb29-580a-4e0d-b1b3-5908af259150");
            }
        }
        ...
        /*protected override Bitmap Icon
        {
            get
            {
                if (_chartStyle.ChartType == "Column") return Properties.Resources.PG_Conduit_Column;
                else if (_chartStyle.ChartType == "Bar") return Properties.Resources.PG_Conduit_Bar;
                else return Properties.Resources.PG_Conduit_LineChart;

                //return Properties.Resources.PG_Conduit_Column;
            }
        }*/
