...
namespace Hive.IO.GhSolar
{
    public class GhPVNoct : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("T_amb", "T_amb", "Ambient temperature hourly time series, 8760 entries, in [°C]", GH_ParamAccess.item);
            pManager.AddNumberParameter("I", "I", "Solar irradiance on the panel. Time series with 8760 entries, in [W/m²]", GH_ParamAccess.item);
        }

        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            pManager.AddNumberParameter("elec", "elec", "Electricity generated by PV panel. Time series with 8760 entries, in [Wh]", GH_ParamAccess.item);
            pManager.AddNumberParameter("effic", "effic", "Temperature dependent efficiency of PV module. Time series with 8760 entries [-]", GH_ParamAccess.item);
        }
