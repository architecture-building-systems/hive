...
namespace Hive.IO.GhSolar
{
    public class GhSumOverTimePeriod : GH_Component
    {
        ...
        {
            pManager.AddTextParameter("sum_mode", "sum_mode", "Summary mode. Options: 'day', 'month', 'year'", GH_ParamAccess.item);
        ...
        public override Guid ComponentGuid => new Guid("0e96d34f-ce2a-4db9-8c21-aa47e4aa6800");
    }
}
