...
namespace Hive.IO.Environment
{
    ...
    public class Environment
    {
        ...
        internal void SetDefaultEnergyPotentials()
        {
            ...
            this.EnergyPotentials[2] = new Pellets(this.Horizon, Enumerable.Repeat<double>(double.MaxValue, this.Horizon).ToArray(), Enumerable.Repeat<double>(0.2, this.Horizon).ToArray(), Enumerable.Repeat<double>(0.1, this.Horizon).ToArray());
            this.EnergyPotentials[2].Name = "ZueriWald";
            this.EnergyPotentials[3] = new Water(this.Horizon, Enumerable.Repeat<double>(double.MaxValue, this.Horizon).ToArray(), Enumerable.Repeat<double>(0.09, this.Horizon).ToArray(), Enumerable.Repeat<double>(0.237, this.Horizon).ToArray(), Enumerable.Repeat<double>(65.0, this.Horizon).ToArray());
            this.EnergyPotentials[3].Name = "DistrictHeating";
            this.EnergyPotentials[4] = new Water(this.Horizon, Enumerable.Repeat<double>(double.MaxValue, this.Horizon).ToArray(), Enumerable.Repeat<double>(0.09, this.Horizon).ToArray(), Enumerable.Repeat<double>(0.237, this.Horizon).ToArray(), Enumerable.Repeat<double>(15.0, this.Horizon).ToArray());
