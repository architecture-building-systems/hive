...
"""
Manually specify a custom thermal zone in the format used in the main branch of 
...
Provided by Hive 0.0.1
    ...
    Returns:
        ...
        debug_string: A string which can be copy-pased into a python script running the rc-model
        zone_variables: variables of the Zone object, for diagnostics.
        
"""

ghenv.Component.Name = "Hive_SpecifyZone"
ghenv.Component.NickName = 'SpecifyZone'
...
Zone, debug_string = main(parameter_dictionary,local_inputs)